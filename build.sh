...
cd ../docker
docker login
docker build -t semweb/caphub_aggregator:v2.0.3 -t semweb/caphub_aggregator:v2.0 -t semweb/caphub_aggregator:v2 -t semweb/caphub_aggregator:latest .
docker push semweb/caphub_aggregator:v2.0.3
